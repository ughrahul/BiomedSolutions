...
export const RealtimeProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  useEffect(() => {
    ...
    // Store ref value in variable to avoid cleanup warning
    ...
    const testConnection = async () => {
      try {
        ...
        logger.warn("⚠️ Database connection failed, using offline mode");
...
export const useRealtimeSubscription = (
  ...
  useEffect(() => {
    ...
    const newChannel = subscribeToTableRef.current(table, (payload) =>
