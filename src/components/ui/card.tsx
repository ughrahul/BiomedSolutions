...
>(
  (
    { className, hover = false, glass = false, gradient = false, ...props },
    ref
  ) => (
    <div
      ref={ref}
      className={cn(
        ...
        glass
          ? "bg-white/80 backdrop-blur-md border-white/20 shadow-2xl"
          : gradient
          ? "bg-gradient-to-br from-white to-purple-50 border-purple-100 shadow-xl"
