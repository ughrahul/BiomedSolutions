...
export default function WebsiteSettings({ className = "" }: WebsiteSettingsProps) {
  ...
  const updateContactSetting = (field: keyof ContactSettings, value: string) => {
  ...
  const updateSocialSetting = (field: keyof SocialMediaSettings, value: string) => {
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-blue-700 mt-1">
              Changes made here will be immediately reflected on your website frontend. 
              Customers will see updated contact information instantly.
            </p>
          </div>
        </div>
      </motion.div>
