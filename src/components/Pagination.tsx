...
export default function Pagination({
  ...
  return (
    <motion.div
      ...
      className={`flex flex-col sm:flex-row items-center justify-between gap-4 py-8 ${className}`}
    >
      {/* Results Info */}
      <motion.div
      ...
      >
        ...
        <EnhancedButton
          ...
          className="flex items-center gap-2 px-3 py-2 text-sm font-medium transition-all duration-200 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
